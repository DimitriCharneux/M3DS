...
;
    ...
    _currentShader=&_perVertexLighting; // les tracés qui suivent se feront avec le shader _perVertexLighting (premier exercice) // on trace toute la scène dans la rtt sauf le projecteur :
    lightPosition();
    drawGround();
    drawEarth();
    drawObject();
